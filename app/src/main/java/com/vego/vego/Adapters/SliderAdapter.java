...
public class SliderAdapter extends PagerAdapter {
    ...
    public String[] slide_desc =
            ...
            {
                    "في هذه الواجهة يستطيع المتدرب ان يحدث من وزنه الحالي في حال حصلت زيادة او نقصان على الوزن المسجل عند واجهة تسجيل البيانات وايضاً يمكن للمستخدم رؤية نبذة عن البرنامج الغذائي/التمارين الخاص به \n\n ملاحظة: قد يستغرق وضع البرنامج الخاص بك عدة ايام",
