...
//------
    ...
    public class HeaderViewHolder extends ViewHolder {
        ...
        public HeaderViewHolder(View view, final ImageView arrow, RelativeLayout relativeLayout) {
            super(view);
        ...
        public void bind(int position) {
            //arrow.setRotation(isExpanded(position) ? openArrow(arrow) : closeArrow(arrow));
